...
--
-- Gép: 127.0.0.1:3306
-- Létrehozás ideje: 2026. Aug 08. 06:18
...
CREATE TABLE IF NOT EXISTS `costumers` (
  ...
  `costumer_name` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `costumer_taxnumber` varchar(13) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `costumer_postal_code` int DEFAULT NULL,
  `costumer_city` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `costumer_address` varchar(60) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `costumer_phonenumber` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `pinebase_order` (
  ...
  `batch_state` tinyint(1) DEFAULT NULL,
  `batch_ordered_date` date DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `pinebatchstate` (
  ...
  `batch_state` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `pinebatch_order` (
  ...
  `batch_quantity` int DEFAULT NULL,
  `batch_arrived_date` timestamp NULL DEFAULT NULL,
  `batch_updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `pinetypes` (
  ...
  `pine_type` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`pine_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `pass_word` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
